...
export default function Provider () {
    ...
    return (
        <Box py={50} style={{background: 'linear-gradient(45deg, #BA0218 50%, #54010B)'}}>
            <Container size="80%">
                <Title order={3} c="white" ta="center" mb="20">Nos Prestataires</Title>
                <Carousel
                    w="100%"
                    slidesToScroll={3}
                    slideSize="33.333333%"
                ...
                >
                    ...
                    <CarouselSlide key={index}>
                        <Card shadow="sm" padding="lg" radius={20} style={{backgroundColor: " #54010B40"}}>
                            <Title order={5} c="white" ta="center" mb="20">{item.title}</Title>
                            ...
                            <Text mb="20" ta="center" size="sm" c="white">{item.description}</Text>
                            <Group align="center" justify="center">
                                <Button href="/" component={Link} c="#BA0218" bg="white" mt="md" radius="md">Read more</Button>
                            </Group>
                        </Card>
                    </CarouselSlide>
                    ))}
