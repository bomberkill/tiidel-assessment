        ...
        <Container py={20} size="80%">
          <Stack justify="center">
            <Group align="center" justify="end">
              <Text href="/" c="#BA0218" component={Link}>
                {t('header.help')}
              </Text>
            </Group>
            <Group gap={130} align="center" justify="end">
              <Group gap={50} align="center" justify="space-between">
                {links.map((item, index) => (
                  <Text key={index} component={Link} href={item.link} c="#4C535D">
                    {t(item.title)}
                  </Text>
                ))}
              </Group>
              <Group justify="space-between" align="center">
                <Menu opened={opened} shadow="md">
                  <Menu.Target>
                    ...
                    >
                      ...
                      {opened ? (
                        <RxCaretUp size={20} color="#BA0218" />
                      ) : (
                        <RxCaretDown color="#BA0218" size={20} />
                      )}
                    </Group>
                  </Menu.Target>
                  <Menu.Dropdown>
                ...
                <Button component={Link} href="/" bg="#4C535D">
                  {t('header.connect')}
                </Button>
              </Group>
            </Group>
