  ...
  const testimonies = [
    {
      ...
      image: landingImage,
      description:
        'Lorem ipsum dolor sit amet consectetur.Neque proin placerat sit feugiat eget risus pharetra sit a.Lorem ipsum dolor sit amet consectetur.Neque proin placerat sit feugiat eget risus pharetra sit a.',
    },
    {
      role: 'CEO AFRIKA GARAGE',
      image: landingImage,
  ...
  return (
    <Box pt="18vh">
      <Box w="100%" pos="relative">
            ...
            <Container size="70%">
              <Stack py={30} pos="relative" gap={40}>
                ...
                <Text ta="center" c="white">
                  Découvrez MsaAda AfriKa, la plateforme numérique qui vous offre une assistance
                  routière rapide et fiable partout en Afrique.
                </Text>
        ...
        <Box pos="absolute" right={0} top={0} w="53%" h={innerHeight}>
          <Image
            priority
      ...
      <Box pt={100}>
        <Container size="70%">
          <Title mb="25" ta="center" c="#BA0218" order={4}>
            Qu'est-ce que MSA Afrika ?
          </Title>
          <Text ta="center">
            MsaAda AfriKa est une plateforme en ligne qui offre une assistance routière rapide et
            fiable aux conducteurs en difficulté en Afrique. Nous utilisons la technologie pour
            connecter les conducteurs avec des professionnels de l'assistance en temps réel. Notre
            objectif est de rendre les routes plus sûres et de garantir la tranquillité d'esprit des
            conducteurs.
          </Text>
        </Container>
      </Box>
      <Box pt={100}>
        ...
        <iframe
          ...
          allowFullScreen
          loading="lazy"
          title="Google Map showing partner location"
      ...
      <Box py={50}>
        <Container size="90%">
            ...
            >
              {testimonies.map((item, index) => (
                <CarouselSlide key={index}>
                  <Paper
                    radius={20}
                    style={{ background: 'linear-gradient(45deg, #BA0218 50%, #54010B)' }}
                  >
                    <Group mih="100%" gap={0} align="center" justify="center" w="100%">
                      <Box h="100%" w="40%" pos="relative">
                        <Image
                          priority
                          style={{
                            objectFit: 'contain',
          ...
          <Box pt={50}>
            <Title order={3} c=" #BA0218" ta="center" mb="20">
              Nos Partenaires
            </Title>
            <Carousel
              w="100%"
      ...
      <Box py={50} style={{ background: 'linear-gradient(to bottom, #BA0218 50%, #54010B)' }}>
        <Container size="90%">
          <Group align="center" justify="space-between">
            <Box>
              <Title mb="md" order={4} c="white" ta="start">
            ...
            <Stack w="40%" align="center" justify="center">
              <TextInput placeholder="Nom" radius={40} w="100%" />
              <TextInput placeholder="Email" radius={40} w="100%" />
